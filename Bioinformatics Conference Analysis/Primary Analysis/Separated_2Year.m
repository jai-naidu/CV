...
%for ECCB
for i = 1993 : 2015
    if i < 2002 || i == 2004 || i > 2005 && mod(i,2) > 0
        ECCB_av(i - 1992) = 0;
        ECCB_med(i - 1992) = 0;
        ECCB_top(i - 1992) = 0;
    ...
    elseif (i < 2004 && i >= 2002) || i == 2005 || i > 2005 && mod(i,2) == 0
...
figure(3)
citation_bars(graph_top,std_top,30,(1:1:23),xlabels);
