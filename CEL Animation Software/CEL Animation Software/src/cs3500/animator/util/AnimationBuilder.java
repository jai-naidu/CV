...
/**
 * A Builder that builds our MovieModel given certain specs (e.g. several motions, setting bounds of
 * canvas, declaring shapes, and adding keyframes).
 *
 * @param <Doc> our MovieModel
 */
public interface AnimationBuilder<Doc> {
   ...
   * @param layer The name of the layer for this shape to be added to
   * @return This {@link AnimationBuilder}
   */
